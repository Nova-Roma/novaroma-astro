...
- [Strategy Map](https://findcongwang.com/lexicon/strategy-map) — Four-layer framework for organizing advisory output
- [Hybrid Intelligence](https://findcongwang.com/lexicon/hybrid-intelligence) — Command center model with event-driven operations
- [IMAGINE Framework](https://findcongwang.com/lexicon/imagine-framework) — Metrics for innovation ecosystem health
