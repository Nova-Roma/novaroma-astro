...
domain_theme: "Sustainability & Regeneration"
parent_questions: []
partner_orgs: ["Arcadia Wellness", "Nova Roma Horizon Innovation Society"]
---
...
- Patterns link to each other through functional relationships:
  - `swale` → `water harvesting` → `food forest establishment` → `biodiversity corridor`
  - `berm` → `microclimate creation` → `zone planning` → `guild composition`
  - `indigenous fire management` → `habitat heterogeneity` → `biodiversity corridor`
...
- [Knowledge Composability](https://findcongwang.com/lexicon/knowledge-composability) — The structural principle enabling cross-tradition knowledge sharing
- [Knowledge Curation and Stewardship](https://findcongwang.com/lexicon/knowledge-curation) — The practice of maintaining a living knowledge commons
- [Perceptiosphere](https://findcongwang.com/lexicon/perceptiosphere) — The architecture enabling composable contribution with sovereignty
- [Active Library](https://findcongwang.com/lexicon/active-library) — Intentional knowledge infrastructure that surfaces relevant material
- [Living Archive](https://findcongwang.com/lexicon/living-archive) — Knowledge that evolves with use rather than decays into static storage

## References

- **Rodale Institute**. (2024). *Regenerative Organic Agriculture and Climate Change: A Down-to-Earth Solution to Global Warming*. https://rodaleinstitute.org/why-organic/regenerative-organic/agriculture-and-climate-change/
- **Holmgren, D.** (2023). *Permaculture: Principles and Pathways Beyond Sustainability*. Holmgren Design Services.
- **Holmgren, D.** (2002). *Permaculture: Principles and Pathways Beyond Sustainability*. Henderson Books.
- **CARE Principles for Indigenous Data Governance**. (2020). https://www.gida-gadg.org/care
- **4 per 1000 Initiative**. (2015). *Soils for Food Security and Climate*. https://www.4p1000.org/
- **WOCAT**. (2024). *Global Database on Sustainable Land Management*. https://www.wocat.net/
- **Regen Network**. (2024). *Technical Framework*. https://www.regennetwork.org/
- **Savory Institute**. (2024). *Holistic Management Framework*. https://savoryinstitute.com/
- **Xu, J., et al.** (2022). *Biodiversity and ecosystem services in regenerative agriculture: A meta-analysis*. *Nature Sustainability*, 5(11), 922-931.
- **Wylant, B.** (2023). *Active Library: Intentional Knowledge Infrastructure*. DBA Thesis.
- **UNESCO**. (2025). *Recommendation on the Ethics of Artificial Intelligence*. https://unesdoc.unesco.org/ark:/48223/pf0000383984
- **UNDRIP**. (2007). *United Nations Declaration on the Rights of Indigenous Peoples*. https://www.un.org/development/desa/indigenouspeoples/declaration-on-the-rights-of-indigenous-peoples.html
