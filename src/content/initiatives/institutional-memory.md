...
image:
  ...
  alt: Community members exploring a large-scale visualization of connected projects and contributors
tags:
...
**A community is defined by the continuity of its ideas. <br/> Most innovation hubs forget this.**
...
| Feature | The Status Quo | The Living Archive |
| :--- | :--- | :--- |
| **Data Format** | Static files and folder hierarchies | Relational knowledge graph |
| **Searchability** | Keyword-based, if indexed | Contextual and generative |
| **Succession** | Dependent on individual effort | Structurally embedded in workflow |
| **Visibility** | Hidden in institutional silos | Visualized as live public infrastructure |
