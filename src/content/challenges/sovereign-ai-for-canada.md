...
- **Climate migration preparation:** Infrastructure deployed for AI compute serves population support later
...
- [How Might We Transcend Bounded Rationality Through Human-AI Collaboration?](https://findcongwang.com/research/questions/ai-collaboration) — Parent CQ
- [How Might We Design a Digital Sovereignty Economy?](https://findcongwang.com/research/questions/digital-sovereignty) — Parent CQ
- [Digital Sovereignty and Work Twins](https://findcongwang.com/lexicon/digital-sovereignty-and-work-twins) — Sovereign ownership framework
- [Hybrid Intelligence](https://findcongwang.com/lexicon/hybrid-intelligence) — Organisational model requiring compute
- [Build-to-Manage](https://findcongwang.com/lexicon/build-to-manage) — Revenue model for infrastructure
- [Innovation Sovereignty](https://findcongwang.com/lexicon/innovation-sovereignty) — National innovation self-determination
